...
var docma = Object.freeze(new DocmaWeb({"version":"3.3.3","routes":[{"id":"api:","type":"api","name":"_def_","path":"api/","contentPath":null,"sourceType":"js"},{"id":"content:license","type":"content","name":"license","path":"license/","contentPath":"content/license.html","sourceType":"md"},{"id":"content:home","type":"content","name":"home","path":"home/","contentPath":"content/home.html","sourceType":"md"}],"apis":{"_def_":{"documentation":[{"comment":"/**\n   * @typedef {uws.js:SSLApp|uws.js:App} TemplatedApp\n   * TemplatedApp is either an SSL or non-SSL app. See App for more info, read user manual.\n   *\n   * @property {function} listen (host: RecognizedString, port: number, cb: (listenSocket: us_listen_socket) => void): TemplatedApp;\n   * Listens to hostname & port. Callback hands either false or a listen socket.\n   *\n   * @property {function} listen (port: number, cb: (listenSocket: any) => void): TemplatedApp;\n   * Listens to port. Callback hands either false or a listen socket.\n   *\n   * @property {function} get (pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\n   * Registers an HTTP GET handler matching specified URL pattern.\n   *\n   * @property {function} post (pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\n   * Registers an HTTP POST handler matching specified URL pattern.\n   *\n   * @property {function} options (pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\n   * Registers an HTTP OPTIONS handler matching specified URL pattern.\n   *\n   * @property {function} del (pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\n   * Registers an HTTP DELETE handler matching specified URL pattern.\n   *\n   * @property {function} patch (pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\n   * Registers an HTTP PATCH handler matching specified URL pattern.\n   *\n   * @property {function} put (pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\n   * Registers an HTTP PUT handler matching specified URL pattern.\n   *\n   * @property {function} head (pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\n   * Registers an HTTP HEAD handler matching specified URL pattern.\n   *\n   * @property {function} connect (pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\n   * Registers an HTTP CONNECT handler matching specified URL pattern.\n   *\n   * @property {function} trace (pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\n   * Registers an HTTP TRACE handler matching specified URL pattern.\n   *\n   * @property {function} any (pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\n   * Registers an HTTP handler matching specified URL pattern on any HTTP method.\n   *\n   * @property {function} ws (pattern: RecognizedString, behavior: WebSocketBehavior) : TemplatedApp;\n   * Registers a handler matching specified URL pattern where WebSocket upgrade requests are caught.\n   *\n   * @property {function} publish (topic: RecognizedString, message: RecognizedString, isBinary?: boolean, compress?: boolean) : TemplatedApp;\n   * Publishes a message under topic, for all WebSockets under this app. See WebSocket.publish.\n   */","meta":{"filename":"uws.js","lineno":24,"columnno":2,"path":"/home/jacekjanpietal/projects/uwebsockets.js/dist","code":{}},"kind":"typedef","name":"TemplatedApp","type":{"names":["uws.js:SSLApp","uws.js:App"]},"description":"TemplatedApp is either an SSL or non-SSL app. See App for more info, read user manual.","properties":[{"type":{"names":["function"]},"description":"(host: RecognizedString, port: number, cb: (listenSocket: us_listen_socket) => void): TemplatedApp;\nListens to hostname & port. Callback hands either false or a listen socket.","name":"listen"},{"type":{"names":["function"]},"description":"(port: number, cb: (listenSocket: any) => void): TemplatedApp;\nListens to port. Callback hands either false or a listen socket.","name":"listen"},{"type":{"names":["function"]},"description":"(pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\nRegisters an HTTP GET handler matching specified URL pattern.","name":"get"},{"type":{"names":["function"]},"description":"(pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\nRegisters an HTTP POST handler matching specified URL pattern.","name":"post"},{"type":{"names":["function"]},"description":"(pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\nRegisters an HTTP OPTIONS handler matching specified URL pattern.","name":"options"},{"type":{"names":["function"]},"description":"(pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\nRegisters an HTTP DELETE handler matching specified URL pattern.","name":"del"},{"type":{"names":["function"]},"description":"(pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\nRegisters an HTTP PATCH handler matching specified URL pattern.","name":"patch"},{"type":{"names":["function"]},"description":"(pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\nRegisters an HTTP PUT handler matching specified URL pattern.","name":"put"},{"type":{"names":["function"]},"description":"(pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\nRegisters an HTTP HEAD handler matching specified URL pattern.","name":"head"},{"type":{"names":["function"]},"description":"(pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\nRegisters an HTTP CONNECT handler matching specified URL pattern.","name":"connect"},{"type":{"names":["function"]},"description":"(pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\nRegisters an HTTP TRACE handler matching specified URL pattern.","name":"trace"},{"type":{"names":["function"]},"description":"(pattern: RecognizedString, handler: (res: HttpResponse, req: HttpRequest) => void) : TemplatedApp;\nRegisters an HTTP handler matching specified URL pattern on any HTTP method.","name":"any"},{"type":{"names":["function"]},"description":"(pattern: RecognizedString, behavior: WebSocketBehavior) : TemplatedApp;\nRegisters a handler matching specified URL pattern where WebSocket upgrade requests are caught.","name":"ws"},{"type":{"names":["function"]},"description":"(topic: RecognizedString, message: RecognizedString, isBinary?: boolean, compress?: boolean) : TemplatedApp;\nPublishes a message under topic, for all WebSockets under this app. See WebSocket.publish.","name":"publish"}],"longname":"TemplatedApp","scope":"global","$longname":"TemplatedApp","$kind":"typedef","$docmaLink":"api/#TemplatedApp"}],"symbols":["TemplatedApp"]}},"app":{"title":"µWebSockets.js Documentation","meta":null,"base":"./","entrance":"content:home","routing":{"method":"path","caseSensitive":true},"server":"github","favicon":""},"template":{"name":"docma-template-zebra","description":"Zebra - Default template for Docma. https://github.com/onury/docma","version":"2.3.1","supportedDocmaVersion":">=2.0.0","author":"Onur Yıldırım","license":"MIT","mainHTML":"index.html","options":{"title":{"label":null},"logo":{"dark":null,"light":null},"sidebar":{"enabled":true,"outline":"flat","collapsed":false,"toolbar":true,"itemsFolded":false,"itemsOverflow":"shrink","badges":true,"search":true,"animations":true},"symbols":{"autoLink":true,"params":"list","enums":"list","props":"list","meta":false},"contentView":{"bookmarks":"h1,h2,h3","faLibs":"all","faVersion":"5.5.0"},"navbar":{"enabled":true,"fixed":true,"dark":false,"animations":true,"menu":[{"label":"µWebSockets.js","href":"home"},{"label":"µWebSockets.js API","items":[{"label":"basic api","href":"api"},{"label":"original repo api docs","href":"https://unetworking.github.io/uWebSockets.js/generated/"}],"chevron":true},{"iconClass":"fas fa-cloud-download-alt","label":"Download","items":[{"label":"<code>yarn add uwebsockets.js -D</code>","href":"https://www.npmjs.com/package/uwebsockets.js","target":"_blank"},{"label":"µWebSockets.js Releases","href":"https://github.com/Prozi/uwebsockets.js/releases","target":"_blank"},{"separator":true},{"label":"License","href":"license"}],"chevron":true},{"iconClass":"fab fa-lg fa-github","label":"","href":"https://github.com/Prozi/uwebsockets.js","target":"_blank"}]}}},"partials":{"api":"docma-api","content":"docma-content","notFound":"docma-404"},"elementID":"docma-main","contentElementID":"docma-content","defaultApiName":"_def_","logsEnabled":false}));
